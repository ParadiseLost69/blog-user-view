      ...
      <div className="container mx-auto flex flex-col">
        <header className="bg-offWhite dark:bg-black flex justify-between m-6 items-center">
          ...
          <div className="flex space-x-2">
            <button className="hidden p-3 w-28 baseline m-1 bg-red-500 hover:bg-red-400 rounded-full md:block shadow-sm outline">
              Register
            </button>
            <button className="hidden p-3 w-28 baseline m-1 px-5 bg-red-500 hover:bg-red-400 rounded-full md:block shadow-sm outline">
              Login
            </button>
          </div>
        </header>
        ...
        >
          <div className="flex flex-col justify-center space-y-1 ">
            <h1 className="text-5xl md:text-left mt-2">Teddy's Blog</h1>
            <p className="text-lg md:text-left">
              A blog dedicated to #tech, #programming, and any thing else I feel
              like talking about.
            </p>
            <div className="flex justify-center md:justify-start  ">
              <button className="p-3 w-28 baseline m-1 bg-red-500 hover:bg-red-400 rounded-full shadow-sm outline md:block">
                View Posts
              </button>
            </div>
          </div>
